...
def construire_tableau_bord(wb: Workbook, cfg: dict, layout: dict) -> None:
    ...
    # pour des graphes openpyxl. Palette Office (look Excel familier, bleu/orange) — le
    # style « Style 1 » natif d'Excel n'est pas reproductible par programme (openpyxl ne
    # gère que les styles 2007 ; les styles 2013+ ne le sont par aucune lib).
